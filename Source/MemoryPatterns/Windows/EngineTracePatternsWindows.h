...
struct EngineTracePatterns {
    [[nodiscard]] static consteval auto addClientPatterns(auto clientPatterns) noexcept
    {
        return clientPatterns
            ...
            .template addPattern<TraceShapeFunctionPointer, CodePattern{"48 89 54 24 ? 48 89 4C 24 ? 55 53 56 57 41 56 41 57 48 8D AC 24 ? ? ? ? B8 ? ? ? ? E8 ? ? ? ?"}>()
            .template addPattern<GameTraceManagerStoragePointer, CodePattern{"48 C7 45 ? 01 10 0C 00 E8 ? ? ? ? 33 C9 89 45 ? E8 ? ? ? ? 48 8B 0D ? ? ? ?"}.add(26).abs()>()
