...
#include "Tabs/VisualsTab/LastTrajectoryVisibilityDropdownSelectionChangeHandler.h"
...
private:
    ...
    void initGrenadePredictionTab(auto&& guiPanel) const
    {
        ...
        initDropDown<LastTrajectoryVisibilityDropdownSelectionChangeHandler<HookContext>>(guiPanel, "grenade_prediction_last_trajectory_visibility");
    ...
    [[nodiscard]] int lastTrajectoryVisibilityIndex() const noexcept
    {
        const auto mode = grenade_prediction_vars::normalizeLastTrajectoryVisibilityMode(
            static_cast<std::uint8_t>(GET_CONFIG_VAR(grenade_prediction_vars::LastTrajectoryVisibility)));
